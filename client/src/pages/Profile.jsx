  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <input
        ...
        {/*      allow read;
      allow write: if
  request.resource.size < 2 * 1024 * 1024 && request.resource.contentType.matches('images/.*')*/}
         <img
        ...
        <p className=' text-sm text-center'>
          {imageError ? ( <span className=' text-red-700'>Error uploading Image (file size must be less 2 MB)</span>) 
        ...
        <input defaultValue={currentUser.email} type="text" id='email' placeholder='Email' className=' bg-slate-100 rounded-lg p-3' onChange={handleChange}/>
      ...
      <span onClick={handleDeleteAcount} className=" text-red-700 cursor-pointer">Delete Account</span>
